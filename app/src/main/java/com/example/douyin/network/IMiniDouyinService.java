...
public interface IMiniDouyinService {
    ...
    Call<PostVideoResponse> upload1(@Query("student_id") String param1, @Query("user_name") String param2, @Part MultipartBody.Part cover_image, @Part MultipartBody.Part video);
